...
class _BibleVerse extends BibleVerse {
  const _BibleVerse({@Id(assignable: true) required this.id, required this.book, required this.chapter, required this.startVerse, this.endVerse, required this.text}): super._();
