...
mixin _$GlobalSettings {
 ...
 bool? get darkModeEnabled; int get seedColor; double get fontSizeScale; bool get showChords; bool get showMusicalNotes; int get accidentals; int get autoScrollSpeedIndex;
...
@useResult
$Res call({
 bool? darkModeEnabled, int seedColor, double fontSizeScale, bool showChords, bool showMusicalNotes, int accidentals, int autoScrollSpeedIndex
});
...
/// Create a copy of GlobalSettings
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? darkModeEnabled = freezed,Object? seedColor = null,Object? fontSizeScale = null,Object? showChords = null,Object? showMusicalNotes = null,Object? accidentals = null,Object? autoScrollSpeedIndex = null,}) {
  return _then(_self.copyWith(
darkModeEnabled: freezed == darkModeEnabled ? _self.darkModeEnabled : darkModeEnabled // ignore: cast_nullable_to_non_nullable
as bool?,seedColor: null == seedColor ? _self.seedColor : seedColor // ignore: cast_nullable_to_non_nullable
as int,fontSizeScale: null == fontSizeScale ? _self.fontSizeScale : fontSizeScale // ignore: cast_nullable_to_non_nullable
as double,showChords: null == showChords ? _self.showChords : showChords // ignore: cast_nullable_to_non_nullable
...
as bool,accidentals: null == accidentals ? _self.accidentals : accidentals // ignore: cast_nullable_to_non_nullable
as int,autoScrollSpeedIndex: null == autoScrollSpeedIndex ? _self.autoScrollSpeedIndex : autoScrollSpeedIndex // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool? darkModeEnabled,  int seedColor,  double fontSizeScale,  bool showChords,  bool showMusicalNotes,  int accidentals,  int autoScrollSpeedIndex)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GlobalSettings() when $default != null:
return $default(_that.darkModeEnabled,_that.seedColor,_that.fontSizeScale,_that.showChords,_that.showMusicalNotes,_that.accidentals,_that.autoScrollSpeedIndex);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool? darkModeEnabled,  int seedColor,  double fontSizeScale,  bool showChords,  bool showMusicalNotes,  int accidentals,  int autoScrollSpeedIndex)  $default,) {final _that = this;
switch (_that) {
case _GlobalSettings():
return $default(_that.darkModeEnabled,_that.seedColor,_that.fontSizeScale,_that.showChords,_that.showMusicalNotes,_that.accidentals,_that.autoScrollSpeedIndex);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool? darkModeEnabled,  int seedColor,  double fontSizeScale,  bool showChords,  bool showMusicalNotes,  int accidentals,  int autoScrollSpeedIndex)?  $default,) {final _that = this;
switch (_that) {
case _GlobalSettings() when $default != null:
return $default(_that.darkModeEnabled,_that.seedColor,_that.fontSizeScale,_that.showChords,_that.showMusicalNotes,_that.accidentals,_that.autoScrollSpeedIndex);case _:
  return null;
...
class _GlobalSettings implements GlobalSettings {
  const _GlobalSettings({this.darkModeEnabled, required this.seedColor, required this.fontSizeScale, required this.showChords, required this.showMusicalNotes, required this.accidentals, required this.autoScrollSpeedIndex});
  factory _GlobalSettings.fromJson(Map<String, dynamic> json) => _$GlobalSettingsFromJson(json);

@override final  bool? darkModeEnabled;
@override final  int seedColor;
@override final  double fontSizeScale;
@override final  bool showChords;
@override final  bool showMusicalNotes;
@override final  int accidentals;
@override final  int autoScrollSpeedIndex;
...
@override
Map<String, dynamic> toJson() {
  return _$GlobalSettingsToJson(this, );
}
...
/// Create a copy of GlobalSettings
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? darkModeEnabled = freezed,Object? seedColor = null,Object? fontSizeScale = null,Object? showChords = null,Object? showMusicalNotes = null,Object? accidentals = null,Object? autoScrollSpeedIndex = null,}) {
...
as int?,transposition: null == transposition ? _self.transposition : transposition // ignore: cast_nullable_to_non_nullable
